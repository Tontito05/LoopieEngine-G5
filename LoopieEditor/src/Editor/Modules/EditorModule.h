...
namespace Loopie {
	...
	private:
		...
		void RenderUI(Camera* camera, std::shared_ptr<Entity> canvas, const vec2& viewportSize);
		void RenderUIRecursive(std::shared_ptr<Entity> entity, const matrix4& projection);
